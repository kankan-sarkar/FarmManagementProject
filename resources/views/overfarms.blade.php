                ...
                <div class="card collapse-icon accordion-icon-rotate">
                    <div id="headingCollapse11" class="card-header">
                        <a data-toggle="collapse" href="#collapse11" aria-expanded="true" aria-controls="collapse11"
                           class="card-title lead">Collapsible Farm Group Item #1</a>
                    </div>
                                                ...
                                                <div class="card-block mt-2">
                                                    <div class="row">
                                                        <div class="col-2 text-center">
                                                            ...
                                                            <i class="wi wi-day-sunny display-block primary font-large-1 my-3"></i>
                                                            <span class="display-block">13°</span>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <span class="display-block">Tue</span>
                                                            <i class="wi wi-day-cloudy display-block primary font-large-1 my-3"></i>
                                                            <span class="display-block">12°</span>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <span class="display-block">Wed</span>
                                                            <i class="wi wi-day-cloudy-gusts display-block primary font-large-1 my-3"></i>
                                                            <span class="display-block">10°</span>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <span class="display-block">Thu</span>
                                                            <i class="wi wi-day-cloudy-windy display-block primary font-large-1 my-3"></i>
                                                            <span class="display-block">12°</span>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <span class="display-block">Fri</span>
                                                            <i class="wi wi-day-fog display-block primary font-large-1 my-3"></i>
                                                            <span class="display-block">9°</span>
                                                        </div>
                                                        <div class="col-2 text-center">
                                                            <span class="display-block">Sat</span>
                                                            <i class="wi wi-day-lightning display-block primary font-large-1 my-3"></i>
                                                    ...
                                                    <svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct"
                                                        ...
                                                        <g>
                                                            <g class="ct-series ct-series-a">
                                                                <line x1="60.749046875" x2="60.748046875" y1="195"
                                                                      y2="38.33333333333334"
                                                                      class="ct-bar" ct:value="53"></line>
                                                                <line x1="162.245140625" x2="162.244140625" y1="195"
                                                                      y2="138.33333333333331"
                                                                      class="ct-bar" ct:value="23"></line>
                                                                <line x1="263.741234375" x2="263.740234375" y1="195"
                                                                      y2="81.66666666666666"
                                                                      class="ct-bar" ct:value="40"></line>
                                                                <line x1="365.237328125" x2="365.236328125" y1="195"
                                                                      y2="115"
                                                                      class="ct-bar"
                                                                      ct:value="30"></line>
                                                            </g>
                                                        ...
                                                        <g class="ct-labels">
                                                            <foreignObject style="overflow: visible;" x="10" y="220"
                                                                           width="101.49609375"
                                                                           height="20"><span
                                                            ...
                                                            <foreignObject style="overflow: visible;" x="111.49609375"
                                                                           y="220"
                                                                           width="101.49609375"
                                                                           height="20"><span
                                                                        class="ct-label ct-horizontal ct-end"
                                                            ...
                                                            <foreignObject style="overflow: visible;" x="212.9921875"
                                                                           y="220"
                                                                           width="101.49609375"
                                                                           height="20"><span
                                                                        class="ct-label ct-horizontal ct-end"
                                                            ...
                                                            <foreignObject style="overflow: visible;" x="314.48828125"
                                                                           y="220"
                                                                           width="101.49609375"
                                                                           height="20"><span
                                                                        class="ct-label ct-horizontal ct-end"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="donut-dashboard-chart" class="height-250 donut">
                                                    <svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct"
                                                        ...
                                                        <g>
                                                            <text dx="215.4921875" dy="125" text-anchor="middle"
                                                                  class="ct-label">100%
                                                            </text>
                                                        </g>
                                                    </svg>
                    ...
                    <div id="headingCollapse12" class="card-header">
                        <a data-toggle="collapse" href="#collapse12" aria-expanded="false" aria-controls="collapse12"
                           class="card-title lead collapsed">Collapsible Farm Group Item #2</a>
                    </div>
                    ...
                    <div id="headingCollapse13" class="card-header">
                        <a data-toggle="collapse" href="#collapse13" aria-expanded="false" aria-controls="collapse13"
                           class="card-title lead collapsed">Collapsible Farm Group Item #3</a>
                    </div>
                    ...
                    <div id="headingCollapse14" class="card-header">
                        <a data-toggle="collapse" href="#collapse14" aria-expanded="false" aria-controls="collapse14"
                           class="card-title lead collapsed">Collapsible Farm Group Item #4</a>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 18px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 dropdown">
                            <button class="btn btn-primary dropdown-toggle" style="width: inherit;" type="button"
