                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="gradient-blackberry d-inline-block rounded-circle mr-1"
                                              style="width:15px; height:15px;"></span> Sales
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-responsive-sm text-center">
                                            ...
                                            <tr>
                                                <td><img class="media-object round-media height-50"
                                                         src="../app-assets/img/elements/07.png"
                                                         alt="Generic placeholder image"/></td>
                                                <td>Headphones</td>
                                                <td>2</td>
                                                <td>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="text-uppercase"><i
                                                    class="fa fa-circle deep-purple font-small-2 mr-1"></i> Visits</span>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card-block">
                                            ...
                                            <div class="my-3 text-center white">
                                                <a class="font-large-2 d-block mb-1">$ 78.89 <span
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col">
                                                    ...
                                                    <div class="progress" style="height: 5px;">
                                                        <div class="progress-bar bg-deep-purple bg-lighten-1" role="progressbar"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="progress" style="height: 5px;">
                                                        <div class="progress-bar bg-blue" role="progressbar" style="width: 28%;"
